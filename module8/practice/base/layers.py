"""
ПРАКТИКА М8 · чотири шари оборони навколо агента специфікації.
...
безкоштовні перевірки практики: python -m pytest practice.
"""

import re

# Імена шарів у порядку додавання — ними підписані шари в README практики.
...
_INPUT_RULES = [
    ...
    ("corpus_fishing",
     re.compile(r"(шлях|путь|path|назв\w+\s+файл|file\s+name).{0,30}"
                r"(корпус|docs|фрагмент|документ)|docs-(full|suite|degraded)|"
