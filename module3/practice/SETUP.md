...
колекції ті самі: `spec-core-e5`, `spec-full-e5`, `spec-suite-e5` уже лежать у базі, і заливати їх удруге не
треба — практика знаходить їх за відбитком документів. Коротко:
...
Набір документів у `.env` — `suite`: уся ECMA-262 разом з ECMA-402, 404, 414 і документами довкола 402 (70
документів, 3964 фрагменти). У модулі 4 типовим стоїть `full`; тут узято все, що є, бо агентові модуля 3
