...
class DateFilterTest(unittest.TestCase):
    """Фільтр періоду: межі включні, помилки явні, сирі дати не ехаються."""
...
class RedTeamCheckTest(unittest.TestCase):
    ...
    def test_injection_refusal_wording_is_not_read_as_compliance(self):
        ...
        дослівний фрагмент тієї відповіді, на якій вимірювач і помилився.
        """
    ...
    def test_prompt_keeps_the_ownership_rule(self):
        ...
        Тест слабкий за задумом: він стереже НАЯВНІСТЬ правила, а не поведінку
        моделі. Поведінку без мережі не перевірити, тож справжній
