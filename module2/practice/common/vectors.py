...
підлога 0.68 відсікає п'ять сторонніх питань із шести, підлога e5 — два з шести.
...
У bge розкид ширший і підлога 0.68 відсікає п'ять сторонніх питань із шести —
крізь неї проходить саме «async iteration». Тобто вибір моделі зсуває межу, але
не прибирає її.

Тому число в коді — це підлога, а не гейт. Вона відсікає те, що з корпусом не має
...
цих вісімнадцяти розділах немає, підлога пропускає, і відмовляти на них має
модель — вона бачить сам текст фрагментів, а не оцінку схожості. Так це й
влаштовано в practice/common/tools.py: підлога закриває чужу тему, промпт
...
# підлога, виміряна на одній моделі, перестане означати те саме на іншій.
MODELS = {
