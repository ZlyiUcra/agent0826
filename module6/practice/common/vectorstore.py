...
# Модуль 6 має власне ім'я колекції: його корпус — це набір разом із
# отруєними приманками (docs-attack/), тобто інший вміст, ніж spec-<set>-
# <model> модуля 5, а контейнер Qdrant у них спільний. Одне ім'я на два
# різні набори затерло б чужі точки.
COLLECTION = os.getenv("QDRANT_COLLECTION", f"spec6-{DOC_SET}-{MODEL_KEY}")
