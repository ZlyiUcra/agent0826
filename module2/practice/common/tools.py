...
Нижня межа схожості у `VectorIndex.retrieve` відсікає запити, у яких з корпусом
...
нижня межа не спиняє: воно з тієї самої теми, що й корпус, і схожість у нього така
