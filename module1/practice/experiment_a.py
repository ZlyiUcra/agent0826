...
Як вимірюємо, без моделі-судді і без очей:
...
# Кандидати. У кожного вказано, який перший хід є ПРАВИЛЬНИМ саме для нього —
# без цього вимірювач карає агента за коректну поведінку (див. історію в README:
# перша версія рахувала правильним лише find_shipments і оголосила зламаним прогін,
# у якому агент цілком слушно пішов одразу в деталі).
CANDIDATES = {
    "phone_singular": {
    ...
    "tracking_only": {
        "query": "Що з посилкою EE404455667UA? Дуже довго немає новин.",
        "expects": "get_shipment_details",
        "note": "телефону немає, є трек-номер — пошук законно пропускається",
    },
    "period_words": {
