"""
Практика М1 — усі стани по сцені на кожен.
...
шість сцен в одному процесі не вкладаються в дефолтний ліміт одного прогону.
Бюджет тут наскрізний: `USAGE` скидається перед кожною сценою заради чистих
поцененарійних чисел, а демо веде власний сумарний підрахунок і передає його
в перевірку. Тобто якщо перші сцени з'їдять ліміт, наступні чесно не стартують —
