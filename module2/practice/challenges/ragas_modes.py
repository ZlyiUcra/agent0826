...
що зробив би сам курс, якби підключав свій `knowledge_qdrant.py` до
`ragas_compare.py` (файл з'явився з оновленням курсу від 26 серпня 2026, але
`ragas_compare.py` його не використовує).
